...
export const categories: Category[] = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        description: "Цель: 2 млн прибыли / 500к на команду. Видео ВК, шаблон договора, инструкции по работе капитана",
      ...
      },
      {
        ...
        description: "Пакет документов для раздачи команде",
        url: "https://t.me/c/3148526643/9",
        type: "template",
        category: "team-lead",
      },
      {
        id: "lead-4",
        title: "Как отметить сбор команды",
        description: "Инструкция по чекинам в кейльте",
        url: "https://t.me/c/3148526643/9",
        type: "article",
        category: "team-lead",
      },
      {
        ...
        description: "Как правильно поднимать статус команды",
        url: "https://t.me/c/3148526643/9",
        type: "article",
        category: "team-lead",
      },
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        description: "Разбор плана масштабирования с видео, документами и тестом",
        url: "https://t.me/c/3148526643/9",
        type: "video",
        category: "team-work",
      },
